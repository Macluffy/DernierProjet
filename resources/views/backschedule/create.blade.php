...
<div >
    <div>
        <h1 class="text-center" style="margin-bottom:40px">Backoffice || Create schedule</h1>
    </div>
    @if ($errors->any())
...
@endif
    <form action="{{ route('schedule.store') }}" style="margin-left:50px" method="post" enctype="multipart/form-data">
    
    @csrf
    <div class="mb-3">
      <label  class="form-label">Time</label>
      <input type="text" class="form-control" style="width: 25%" name="time" value="{{  old('time')  }}" >
