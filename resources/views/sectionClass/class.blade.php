...
<section class="class-area fix bg-gray pb-100 pt-95">
    ...
    <div class="container">
        ...
        <div class="row"> 
            ...
            @if ($value->filtre == "accepter" &&  $b < 3 && $b > 1)
            ...
            @elseif ($value->filtre == "accepter" &&  $dateactuel == $datecour && $timernow >= $timerclass)
            ...
            @elseif ($value->filtre == "accepter" &&  $dateactuel >= $datecour )
            ...
            @elseif ($value->filtre == "accepter" &&  $b == 0)
